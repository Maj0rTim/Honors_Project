...
public class MessageQueueChannel 
{
    ...
    public void write(byte[] data, int type) throws IOException {
        ...
        while (totalBytesWritten < totalBytes) {
            ...
            if (ipc.msgsnd(msgqid, buffer, bytesToWrite, type, 0) == -1) {
    ...
    public byte[] read(int totalBytes, int type) throws IOException {
        ...
        while (totalBytesRead < totalBytes) {
            ...
            if ((bytesRead = ipc.msgrcv(msgqid, buffer, bytesToRead, type, 0)) == -1) { 
